...
For each taxon, we sampled genetic data from a two populations currently on
separate islands previously connected during glacial periods.
...
By utilizing all of the information the data, the method promises to be much
...
As a complement to this work on oceanic islands, I am also working with an
...
I will collaborate with Mark Holder to do this using a hierarchical Bayesian
model that treats population assignment as Dirichlet process.
...
For the first stage of this projcet, we will elucidate the evolutionary context
