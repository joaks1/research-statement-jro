...
The evolutionary scenarios the students design using
...
% hundreds of bent-toed geckos (\spp{Cyrtodactylus}) from
% across Southeast Asia
% to test whether
% biogeographical processes
% have affected lineages differently, depending on their habitat preferences.

% I have a pending NSF CAREER proposal to fund this work
