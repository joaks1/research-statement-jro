...
\newrobustcmd*{\shortfullcite}{\AtNextCite{\renewbibmacro{eprint}{}\renewbibmacro{title}{}\renewbibmacro{in:}{}\renewbibmacro{number}{}}\hspace{-0.6em}\fullcite}
...
\titleformat{\section}[hang]
    ...
    {\S\ \thesection.}{.5em}{}[]
\titlespacing{\section}
    {0mm}{0.1ex plus .05ex minus .05ex}{0ex}

\titleformat{\subsection}[hang]
    {\large\sffamily\itshape}
    {\S\ \thesection.}{.5em}{}[]
\titlespacing{\subsection}
    {0mm}{0.5ex plus .01ex minus .01ex}{0ex}
...
\newcommand{\Ecoevolity}{Ecoevolity\xspace}
\newcommand{\revbayes}{RevBayes\xspace}
